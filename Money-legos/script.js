const { ethers } = require("ethers"); //alternative to web3, includes @studydefi
const erc20 = require("@studydefi/money-legos/erc20");
const kyber = require("@studydefi/money-legos/kyber");

const provider = new ethers.providers.JsonRpcProvider(
  process.env.PROVIDER_URL || "http://localhost:8545", //ethereum netwrok access provider - replace with Infura URL
);
