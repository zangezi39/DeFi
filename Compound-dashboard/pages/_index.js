...
import calculateApy from '../_apy.js';


export default function Home({ apys }) {
  const formatPercent = number =>       //function with 'number' as argument
    `${new Number(number).toFixed(18)}%` //shorthand notation without 'return' keyword
